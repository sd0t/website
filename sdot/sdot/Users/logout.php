...
<!doctype html>
<?php 
//this will overwrite the session with blank spaces, erasing the session info. 
session_start();
		...
		$_SESSION[$cookie_FName] = $cookie_FName_info;
		$_SESSION[$cookie_LName] = $cookie_LName_info;
