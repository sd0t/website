...
<?php
  ...
  if(isset($_COOKIE["SDOT_user_project"])) {
    $BProjectID = $_COOKIE["SDOT_user_project"];
  }
  else {
...
$sql = "INSERT INTO Bugs (SourceFile, Location, Description, Status, BProjectID, BReporterID, BAssignedID)  
VALUES ('". $SourceFile ."','". $Location ."','". $Description ."','". $Status ."','". $BProjectID ."','". $BReporterID ."','". $BAssignedID ."')";
