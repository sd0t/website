          ...
          <?php
            ...
            $qureyString = "SELECT Username, FName, LName, Password, Email FROM Users WHERE UserID = ". $UserID .";";
             ...
             if($result = mysqli_query($conn, $qureyString)){
              ...
              echo "
  <form action= 'userPreferencesSubmit.php' id = 'usersPref'  action ='post' >
       ...
       <label>
              <thead>
                <tr>
                  <th>First Name:</th>
                  <td>
                    <input type = 'text' id='first' name = 'FName' size = '45' value=". $FName .">
                  </td>
                </tr>
              </label>
              </thead>
       ...
       <label>
              ...
              <thead>
                <tr>
                  <th>Password:</th>
                  <td>
                    <input type = 'password' id='intialp' name = 'Password' size = '45' value=". $Password .">
                  </td>
                </tr>
              </label>
              </thead>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <input type = 'password' id='secondp' name = 'Password' size = '45' value=". $Password ."/>
                  </td>
                </tr>                                
                <label>
              </tbody>
