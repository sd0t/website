...
session_start();
    ...
    //QUERY SUBMIT
    $queryString = "SELECT BugID, Users1.Username, Users2.Username, SourceFile, Location, Description, Status , BReporterID , BAssignedID FROM Bugs, Users Users1, Users Users2 WHERE (BProjectID = " . $ProjectID. ") AND (BugID = " . $BugID. ") AND (Users1.UserID =  BReporterID) AND (Users2.UserID = BAssignedID);";
            ...
            <table class='table table-striped'>
              <thead>
                <tr>
                  ...
                  echo " <option value=". $BReporterID ." Selected='selected'> Original Entry: ". $Users1Username ." </option>
                  </select>
                  </td>
                </tr>
              </thead>
              <tbody>
                <tr>
                  ...
                  echo " <option value=". $BAssignedID ." Selected='selected'> Original Entry: ". $Users2Username ." </option>
                </select>
                  </td>
                </tr>
                  <tr>
