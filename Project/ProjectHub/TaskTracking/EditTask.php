...
<main role="main" class="col-sm-9 ml-sm-auto col-md-10 pt-3">
  ...
  if(isset($_SESSION["SDOT_user_login"])) {
    ...
    $queryString = "SELECT TaskID, Priority, Task, Complete, Username, SCRUM, Remarks, TAssignedID
                    FROM Tasks, Users 
      ...
      while($row = mysqli_fetch_array($result)){
        ...
        if ($result2=mysqli_query($conn,$sql)){
          ...
          mysqli_free_result($result2); 
               ...
               echo " <option value=". $TAssignedID ." Selected='selected'> Original Entry: ". $AssignedTo ." </option>
                    </select>
                  </td>
                </tr>
