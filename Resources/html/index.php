<!--
  HOMEPAGE {s.dot}
  http://cis444.cs.csusm.edu/nguye208/sdot/Resources/html/index.html
  ** DENISE THUY VY NGUYEN 
  http://cis444.cs.csusm.edu/nguye208/sdot/html/index.html
  ** =^.,.^= 10-23-2017
-->
<!doctype html>
<html lang="en">
...
<!--TOP NAV-->
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
         ...
         <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../../Users/logout.php">Logout - 
			...
			<?php
				...
				echo  $_SESSION[$cookie_FName] . "  " . $_SESSION[$cookie_LName]
			?>
			</a>
          </li>
        </ul>
